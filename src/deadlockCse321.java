...
public class deadlockCse321 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (checkIfAnyProcessIsleft(finish) && count<100){

            System.out.println(Arrays.toString(avaiableResource) +" "+Arrays.toString(work));
            //System.out.println( lessthan(ResourseRequired[i],work) +" "+!finish[i] );
            if (!finish[i] && checkTwoArrays(avaiableResource,work) ){
